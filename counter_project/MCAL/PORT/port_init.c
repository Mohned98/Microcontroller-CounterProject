...
/**
  * @brief This function Initialize port based on selected port_index (0 to 5)
  *        indicating from A to F ports by enabling the clock, unlocking the port,
	*				 and making the selected mode digital.
  * @param port_index specifies the number of port that is going to be intialized.
  * @retval None
  */
